<template>
  <div id="comm_layout_footer" class="layout  none" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
    <div class="view_contents">
      <div id="div_includeBlock_1494210733307" class="view includeBlock div  none includeView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
        <div names="div" class="view_contents">
          <div id="image_style_01_1494210733495" class="view style_01 image  none" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="image" class="view_contents">
              <div class="imgStyle CompatibleImg">
                <a href='javascript:;' target="">
                  <img class="picSet link-type-" src="img\footer\z_11\a1ffc05a8ee0bd7d1d3247d6dc679f88.png" title="" alt="描述" id="imageModeShow">
                </a>
              </div>
              <!-- 新加的js  -->
            </div>
          </div>
          <div id="text_style_02_1494210733500" class="view style_02 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="text" class="view_contents">
              全景官方微信
            </div>
          </div>
          <div id="image_style_01_1494210733503" class="view style_01 image  none" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="image" class="view_contents">
              <div class="imgStyle CompatibleImg">
                <a href='javascript:;' target="">
                  <img class="picSet link-type-" src="img\footer\z_11\a1ffc05a8ee0bd7d1d3247d6dc679f88.png" title="" alt="描述" id="imageModeShow">
          ...
          <div id="text_style_02_1494210733508" class="view style_02 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="text" class="view_contents">
              全景官方微博
            </div>
          </div>
          <div id="text_style_02_1494210733519" class="view style_02 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="text" class="view_contents">
              Email：yimin@mail.com
            </div>
          </div>
          <div id="image_style_01_1494210733522" class="view style_01 image  none" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="image" class="view_contents">
              <div class="imgStyle CompatibleImg">
                <a href='javascript:;' target="">
          ...
          <div id="image_style_01_1494210733528" class="view style_01 image  none" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="image" class="view_contents">
              <div class="imgStyle CompatibleImg">
                <a href='javascript:;' target="">
                  <img class="picSet link-type-" src="img\footer\z_09\7c3681ea1c7654a673d25055d5e7bfa2.png" title="" alt="描述" id="imageModeShow">
                </a>
              </div>
              <!-- 新加的js  -->
            </div>
          </div>
          <div id="text_style_02_1494210733531" class="view style_02 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="text" class="view_contents">
              电话：0786-5487XXX
            </div>
          </div>
          <div id="text_style_02_1494210733534" class="view style_02 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
            <div names="text" class="view_contents">
              目前已发展成为集电视剧、电影、艺人经纪、动画与新媒体业务于一体、各业务版块互动发展、全媒体整合开发的大型传媒机构。
            </div>
          </div>
          <div id="dh_style_03_1494210733548" class="view style_03 dh  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                ...
                <div class="ddsmoothmenu-v">
                  <ul class="menuUl01 columnSet">
                    ...
                    <li class="menuLi01 mainMenuSet">
                      <a href="61844-61844.html">联系</a>
                    </li>
                    <li class="menuLi01 mainMenuSet">
                      <a href="61845-61845.html">新闻</a>
                    </li>
                    <li class="menuLi01 mainMenuSet">
                      <a href="61846-61846.html">关于</a>
                    </li>
                    <li class="menuLi01 mainMenuSet">
                      <a href="61847-61847.html">案例</a>
                    </li>
                  </ul>
                </div>
                    ...
                    <div class="header_scroll">
                      <ul class="mobi_menuUl01">
                        <li class="mobi_menuLi01">
                          <div class="mobi_border">
                            <a href="index.html">首页</a>
                          </div>
                        </li>
                        <li class="mobi_menuLi01">
                          <div class="mobi_border">
                            <a href="61844-61844.html">联系我们</a>
                          </div>
                        </li>
                        <li class="mobi_menuLi01">
                          <div class="mobi_border">
                            <a href="61845-61845.html">新闻中心</a>
                          </div>
                        </li>
                        <li class="mobi_menuLi01">
                          <div class="mobi_border">
                        ...
                        <li class="mobi_menuLi01">
                          <div class="mobi_border">
                            <a href="61847-61847.html">产品案例</a>
                          </div>
                        </li>
                      </ul>
                      <!-- 菜单区域 End-->
                      <div id="text_style_11_1494210733537" class="view style_11 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                        <div names="text" class="view_contents">
                          QUANJING
                        </div>
                      </div>
                      <div id="text_style_11_1494210733552" class="view style_11 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                        <div names="text" class="view_contents">
                          MENU
                        </div>
                      </div>
                      <div id="text_style_11_1494210733488" class="view style_11 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                        <div names="text" class="view_contents">
                          QUANJING
                        </div>
                      </div>
                      <div id="image_logo_1494210733516" class="view logo image  none" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                        <div names="image" class="view_contents">
                          <div class="logoStyle modSet">
                            <a href='index.html' target="_self">
                              <img class="imgSet" src="img\logo.png?1505469164" title="" alt="" style="width:100%; height:auto">
                            </a>
                          </div>
                        </div>
                      </div>
                      <div id="qqol_style_01_1496216235557" class="view style_01 qqol  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                      ...
                      <div id="text_style_02_1505368577600" class="view style_02 text  none lockHeightView" data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
                        <div names="text" class="view_contents">
                          ****@版权所属 Copyright@2000-2016 N****C.net,Inc. &nbsp; All rights reserved
                        </div>
                      </div>
                    </div>
                  </div>
...
function remove_qqol_qqol_style_01_1496216235557(){
  $('body > .online-service.qqol-qqol_style_01_1496216235557').remove();
}
// 创建在线客服
$(function () {
  // 清理旧的
  remove_qqol_qqol_style_01_1496216235557();

  // 创建边栏
  var sidebar = new Sidebar({
    'template': 'online-template',
    'css': 'qqol-qqol_style_01_1496216235557',
    'expand': false,
  ...
  var qqOnlineStr = '<div class="clearfix">' +
          ...
          'onerror="javascript:this.src=\'http://wpa.qq.com/pa?p=2:123456789:{{style}}\';">' +
  ...
  fragmentList.append(new Fragment({
    'name':'qq-online',
    'html':qqOnlineStr,
    'data':{'qq':'410541515', 'style':3, 'title':'QQ在线', 'text':'客服一'},
    'css':{'margin':'.5em 0'}
  }));
  fragmentList.append(new Fragment({
    'name':'qq-online',
    'html':qqOnlineStr,
    'data':{'qq':'410541515', 'style':3, 'title':'QQ在线', 'text':'客服二'},
    'css':{'margin':'.5em 0'}
  }));
  fragmentList.append(new Fragment({
    'name':'separator',
